...
debug-console () {
    XDEBUG_CONFIG="remote_host=10.10.0.1" PHP_IDE_CONFIG="serverName=zed.wf.akona.local" /data/shop/development/current/vendor/bin/console $*
}
...
# XDebug
alias debug='XDEBUG_CONFIG="remote_host=10.10.0.1" PHP_IDE_CONFIG="serverName=zed.wf.akona.local"'
